...
Buildings in the Sugarverse are made of tasty treats and only require CNDY to be constructed and upgraded. Each building is also a non-fungible and transferable digital asset (using the ERC-721 standard for NFTs) and depending on their purpose or level they can deliver more profits.  Each type of building has 3 levels and each consequent one requires more land:
